...
impl Visitor for SymbolGeneration<'_> {
    ...
    fn visit_distinct_type(&mut self, node: &mut DistinctType, ctx: &mut TypeAliasContext) {
        ...
        let sym = self.sym_table.add_distinct_type(&ctx.scope, name);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_opaque_type(&mut self, node: &mut OpaqueType, ctx: &mut TypeAliasContext) {
        ...
        let sym = self.sym_table.add_opaque_type(&ctx.scope, name);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_struct(&mut self, node: &mut Struct, ctx: &mut StructContext) {
        ...
        let sym = self.sym_table.add_struct(&ctx.scope, name, StructKind::Normal);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_tuple_struct(&mut self, node: &mut TupleStruct, ctx: &mut StructContext) {
        ...
        let sym = self.sym_table.add_struct(&ctx.scope, name, StructKind::Tuple);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_unit_struct(&mut self, node: &mut UnitStruct, ctx: &mut StructContext) {
        ...
        let sym = self.sym_table.add_struct(&ctx.scope, name, StructKind::Unit);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_union(&mut self, node: &mut Union, ctx: &mut UnionContext) {
        ...
        let sym = self.sym_table.add_union(&ctx.scope, name);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_adt_enum(&mut self, node: &mut AdtEnum, ctx: &mut AdtEnumContext) {
        ...
        let sym = self.sym_table.add_adt_enum(&ctx.scope, name);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_flag_enum(&mut self, node: &mut FlagEnum, ctx: &mut FlagEnumContext) {
        ...
        let sym = self.sym_table.add_flag_enum(&ctx.scope, name);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_bitfield(&mut self, node: &mut Bitfield, ctx: &mut BitfieldContext) {
        ...
        let sym = self.sym_table.add_bitfield(&ctx.scope, name);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_extern_static(&mut self, node: &mut ExternStatic, ctx: &mut StaticContext) {
        ...
        let sym = self.sym_table.add_static(&ctx.scope, name, StaticKind::Extern);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_trait(&mut self, node: &mut Trait, ctx: &mut TraitContext) {
        ...
        let sym = self.sym_table.add_trait(&ctx.scope, name);
        ctx.sym = Some(sym);
    }
    ...
    fn visit_impl(&mut self, node: &mut Impl, ctx: &mut ImplContext) {
        // TODO:
        let name = todo!();// self.names[node.name].to_string();
        
        let sym = self.sym_table.add_impl(&ctx.scope, name);
        ctx.sym = Some(sym);
    }
